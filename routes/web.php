...
Route::middleware(['auth', 'force.logout', 'check.status'])->group(function () {
...
Route::middleware(['auth', 'admin', 'force.logout', 'check.status'])->prefix('admin')->name('admin.')->group(function () {
