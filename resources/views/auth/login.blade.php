...
<div class="mb-6 text-center">
    <h2 class="text-3xl font-serif text-luxury-dark mt-6 mb-2">Welcome Back</h2>
...
<form method="POST" action="{{ route('login') }}" class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        ...
        @if (Route::has('password.request'))
            <a href="{{ route('password.request') }}" class="text-sm font-medium text-luxury-dark hover:text-luxury-gold transition-colors">Forgot password?</a>
        @endif
    </div>
...
<p class="mt-8 text-center text-sm text-gray-600">
    ...
    <a href="{{ route('register') }}" class="font-medium text-luxury-dark hover:text-luxury-gold uppercase tracking-wider ml-1 transition-colors border-b border-luxury-gold">Create one</a>
</p>
@endsection
