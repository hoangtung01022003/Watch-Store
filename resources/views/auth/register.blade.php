...
<div class="mb-6 text-center">
    <h2 class="text-3xl font-serif text-luxury-dark mt-6 mb-2">Create an Account</h2>
    <p class="text-sm text-gray-500 uppercase tracking-widest">Join us for a premium experience</p>
...
<form method="POST" action="{{ route('register') }}" class="space-y-6">
    ...
    <div>
        <label for="name" class="block text-xs font-semibold text-gray-700 uppercase tracking-wider">Full Name</label>
...
<p class="mt-8 text-center text-sm text-gray-600">
    ...
    <a href="{{ route('login') }}" class="font-medium text-luxury-dark hover:text-luxury-gold uppercase tracking-wider ml-1 transition-colors border-b border-luxury-gold">Sign in here</a>
</p>
@endsection
