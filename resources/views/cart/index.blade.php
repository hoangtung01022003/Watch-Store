<x-customer>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h1 class="text-3xl font-serif text-luxury-dark mb-8">Shopping Cart</h1>
            ...
            <div class="flex flex-col lg:flex-row gap-8">
                                        ...
                                        <td class="py-6 px-6 flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <form action="{{ route('cart.remove', $id) }}" method="POST" class="mt-2">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="text-xs text-red-500 hover:text-red-700 uppercase tracking-widest transition-colors">Remove</button>
                                                </form>
                                            </div>
                                        </td>
                ...
                <div class="w-full lg:w-1/3">
                    <div class="bg-white border border-gray-100 shadow-sm p-6">
                        <h2 class="font-serif text-xl text-luxury-dark mb-6 border-b border-gray-100 pb-4">Order Summary</h2>
        ...
        @else
            <div class="text-center py-20 bg-white border border-gray-100 shadow-sm">
                ...
                <h2 class="font-serif text-2xl text-luxury-dark mb-4">Your Shopping Cart is Empty</h2>
                <p class="text-gray-500 mb-8 max-w-md mx-auto">Explore our exclusive collections and find the perfect timepiece.</p>
