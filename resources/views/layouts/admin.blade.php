...
<body class="font-sans antialiased bg-gray-50 flex h-screen overflow-hidden text-gray-900">
    ...
    <aside class="w-64 bg-white border-r border-gray-200 hidden md:flex flex-col h-full shadow-sm z-10">
        ...
        <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
            ...
            <a href="{{ route('admin.banners.index') }}" class="group flex items-center px-2.5 py-2.5 text-sm font-medium rounded-lg transition-colors {{ request()->routeIs('admin.banners.*') ? 'bg-indigo-50 text-indigo-700' : 'text-gray-700 hover:bg-gray-50 hover:text-indigo-600' }}">
                <svg class="mr-3 h-5 w-5 flex-shrink-0 transition-colors {{ request()->routeIs('admin.banners.*') ? 'text-indigo-700' : 'text-gray-400 group-hover:text-indigo-600' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="#" class="flex items-center px-3 py-2.5 text-gray-600 hover:bg-gray-50 hover:text-gray-900 rounded-lg font-medium group transition-colors">
                <svg class="w-5 h-5 mr-3 text-gray-400 group-hover:text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/></svg>
                Customers
            </a>
        </nav>
