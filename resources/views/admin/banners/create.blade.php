...
<div class="max-w-3xl">
    <div class="mb-6">
        <h2 class="text-2xl font-bold text-gray-900 tracking-tight">Add New Banner</h2>
        <p class="text-sm text-gray-500 mt-1">Upload a new banner for your storefront.</p>
    </div>
    ...
    <form action="{{ route('admin.banners.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-xl border border-gray-200 shadow-sm p-6 space-y-6">
        ...
        <div x-data="bannerImageUpload()">
            ...
            <div x-show="!preview">
                ...
                <p class="text-xs text-gray-500 mt-1">Recommended size: 1920x820px, Max 4MB.</p>
            </div>
        ...
        <div class="pt-4 flex justify-end gap-3 border-t border-gray-100">
            ...
            <button type="submit" class="px-5 py-2.5 border border-transparent rounded-lg text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 transition-colors shadow-sm">Save Banner</button>
        </div>
    </form>
</div>
