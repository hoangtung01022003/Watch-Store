...
<div class="mb-6">
    <div class="flex items-center gap-2 text-sm text-gray-500 mb-2">
        ...
        <span>/</span>
        <a href="{{ route('admin.products.index') }}" class="hover:text-indigo-600 transition-colors">Sản Phẩm</a>
        <span>/</span>
        <span class="text-gray-900 font-medium">Thêm mới</span>
    </div>
    <h2 class="text-2xl font-bold text-gray-900 tracking-tight">Thêm Sản Phẩm Mới</h2>
    <p class="text-sm text-gray-500 mt-1">Tạo một sản phẩm đồng hồ mới cho cửa hàng của bạn.</p>
</div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
                <h3 class="text-lg font-semibold text-gray-900 mb-4 border-b border-gray-100 pb-3">Thông Tin Cơ Bản</h3>
                
                <div class="space-y-4">
                    <div>
                        <label for="name" class="block text-sm font-medium text-gray-700 mb-1">Tên Sản Phẩm <span class="text-red-500">*</span></label>
                        <input type="text" id="name" name="name" value="{{ old('name') }}" class="block w-full border border-gray-300 rounded-lg p-2.5 text-sm text-gray-900 focus:ring-indigo-500 focus:border-indigo-500 transition-colors" placeholder="VD: Rolex Submariner" required>
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="5" class="block w-full border border-gray-300 rounded-lg p-2.5 text-sm text-gray-900 focus:ring-indigo-500 focus:border-indigo-500 transition-colors" placeholder="Mô tả chi tiết sản phẩm...">{{ old('description') }}</textarea>
            ...
            <!-- Specifications -->
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
                <h3 class="text-lg font-semibold text-gray-900 mb-4 border-b border-gray-100 pb-3">Thông Số Kỹ Thuật</h3>
                
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label for="case_size" class="block text-sm font-medium text-gray-700 mb-1">Kích Thước Mặt</label>
                        <input type="text" id="case_size" name="case_size" value="{{ old('case_size') }}" class="block w-full border border-gray-300 rounded-lg p-2.5 text-sm text-gray-900 focus:ring-indigo-500 focus:border-indigo-500" placeholder="VD: 40mm">
                        @error('case_size') <p class="mt-1 text-sm text-red-600">{{ $message }}</p> @enderror
                    </div>
                    
                    <div>
                        <label for="water_resistance" class="block text-sm font-medium text-gray-700 mb-1">Độ Chống Nước</label>
                        <input type="text" id="water_resistance" name="water_resistance" value="{{ old('water_resistance') }}" class="block w-full border border-gray-300 rounded-lg p-2.5 text-sm text-gray-900 focus:ring-indigo-500 focus:border-indigo-500" placeholder="VD: 50m">
                        @error('water_resistance') <p class="mt-1 text-sm text-red-600">{{ $message }}</p> @enderror
                    </div>
                    
                    <div>
                        <label for="strap_material" class="block text-sm font-medium text-gray-700 mb-1">Chất Liệu Dây</label>
                        <input type="text" id="strap_material" name="strap_material" value="{{ old('strap_material') }}" class="block w-full border border-gray-300 rounded-lg p-2.5 text-sm text-gray-900 focus:ring-indigo-500 focus:border-indigo-500" placeholder="VD: Thép không gỉ">
                        @error('strap_material') <p class="mt-1 text-sm text-red-600">{{ $message }}</p> @enderror
                    </div>
                    
                    <div>
                        <label for="movement" class="block text-sm font-medium text-gray-700 mb-1">Bộ Máy</label>
                        <input type="text" id="movement" name="movement" value="{{ old('movement') }}" class="block w-full border border-gray-300 rounded-lg p-2.5 text-sm text-gray-900 focus:ring-indigo-500 focus:border-indigo-500" placeholder="VD: Automatic">
                        @error('movement') <p class="mt-1 text-sm text-red-600">{{ $message }}</p> @enderror
                    </div>
                    
                    <div class="md:col-span-2">
                        <label for="glass_type" class="block text-sm font-medium text-gray-700 mb-1">Loại Kính</label>
                        <input type="text" id="glass_type" name="glass_type" value="{{ old('glass_type') }}" class="block w-full border border-gray-300 rounded-lg p-2.5 text-sm text-gray-900 focus:ring-indigo-500 focus:border-indigo-500" placeholder="VD: Kính Sapphire">
        ...
        <div class="space-y-6">
            <!-- Pricing & Status -->
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
                <h3 class="text-lg font-semibold text-gray-900 mb-4 border-b border-gray-100 pb-3">Giá & Tồn Kho</h3>
                ...
                <div class="space-y-4">
                    ...
                    <div class="pt-2">
                        <label class="flex items-center cursor-pointer">
                            ...
                            <span class="ms-3 text-sm font-medium text-gray-700">Sản phẩm đang hoạt động</span>
                        </label>
                    </div>
                </div>
            </div>
            ...
            <!-- Media -->
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
                <h3 class="text-lg font-semibold text-gray-900 mb-4 border-b border-gray-100 pb-3">Hình Ảnh</h3>
                ...
                <div class="space-y-4">
                    <div x-data="mainImageUpload()">
                        ...
                        <div x-show="!preview">
                            ...
                            <p class="mt-1 text-xs text-gray-500">JPG, PNG, WEBP tối đa 2MB.</p>
                        </div>
                        @error('image') <p class="mt-1 text-sm text-red-600">{{ $message }}</p> @enderror
                    </div>
                    
                    <div class="pt-2 border-t border-gray-100" x-data="galleryUpload()">
                        <label for="gallery" class="block text-sm font-medium text-gray-700 mb-1">Ảnh Phụ</label>
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-xs text-gray-500">Tải lên nhiều ảnh phụ.</p>
                        </div>
