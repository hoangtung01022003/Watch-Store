...
<div class="mb-6">
    ...
    <h2 class="text-2xl font-bold text-gray-900 tracking-tight">Sửa Thương Hiệu</h2>
    <p class="text-sm text-gray-500 mt-1">Cập nhật thông tin chi tiết cho thương hiệu.</p>
</div>
