...
<div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
    <div>
        <h2 class="text-2xl font-bold text-gray-900 tracking-tight">Brands</h2>
        <p class="text-sm text-gray-500 mt-1">Manage product brands in your store.</p>
    </div>
        ...
        <table class="w-full text-left border-collapse">
            <thead>
                <tr class="bg-gray-50 text-gray-700 text-sm border-b border-gray-200">
                    ...
                    <th class="px-6 py-4 font-semibold">Brand Info</th>
                    <th class="px-6 py-4 font-semibold text-center">Country</th>
                    <th class="px-6 py-4 font-semibold text-center w-32">Products</th>
                ...
                <tr class="hover:bg-gray-50 transition-colors">
                    ...
                    <td class="px-6 py-4 text-right">
                        <div class="flex items-center justify-end gap-2">
                            <a href="{{ route('admin.brands.edit', $brand) }}" class="p-2 text-indigo-600 hover:bg-indigo-50 rounded-lg transition-colors" title="Edit">
                ...
                <tr>
                    <td colspan="5" class="px-6 py-10 text-center text-gray-500">
                        <div class="flex flex-col items-center">
                            ...
                            <p class="text-base font-medium text-gray-900 mb-1">No brands found</p>
                            <a href="{{ route('admin.brands.create') }}" class="text-sm font-medium text-indigo-600 hover:text-indigo-800">Create your first brand</a>
                        </div>
                    </td>
                </tr>
                @endforelse
